...
import com.tokenautocomplete.sample.FilteredArrayAdapter;
...
public class TokenActivity extends Activity implements TokenCompleteTextView.TokenListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        people = new Person[]{
                new Person("Vishnupriyan P", "vishnupriyanljcet@gmail.com"),
                new Person("abc", "abc@example.com"),
                new Person("def", "def@example.com"),
                new Person("ghi", "ghi@example.com"),
                new Person("jkl", "jkl@example.com"),
                new Person("mno", "mno@example.com")
        };
